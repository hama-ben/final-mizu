...
import { startCouponLifecycleJobs } from "./lib/coupon-lifecycle";
import { startOrderTimeoutSweep } from "./lib/order-timeout-sweep";
import { startMonthlyDriverAwardsJob } from "./lib/monthly-driver-award";
...
runMigrations()
  ...
  .then(() => {
    httpServer.listen(port, () => {
      ...
      startFavoriteSweep();
      startCouponLifecycleJobs();
      startOrderTimeoutSweep();
      startMonthlyDriverAwardsJob();
    });
  });
