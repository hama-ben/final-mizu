...
- `pnpm --filter @workspace/talabati run dev` — run the frontend (port 5000)
- Replit workflows: `Talabati API` runs the API on port 8080 and `Talabati Web` runs the Talabati frontend on port 5000 for the web preview
...
- Frontend: React + Vite (port 5000 in the Replit preview; artifact config uses 19283), Radix UI, Tailwind CSS, shadcn/ui
